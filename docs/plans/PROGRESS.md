...
> **설계 문서**: `docs/plans/2026-01-10-phase3-watchlist-design.md`

### 전체 Task 목록

| # | Task | 상태 | 우선순위 |
|---|------|------|----------|
| 3-1 | 종목 직접 지정 (Watchlist) | 🔄 진행중 | P1 |
| 3-2 | AI 자동 스캔 (옵션) | ⏳ 대기 | P3 |
| 3-3 | Telegram Bot 연동 | ⏳ 대기 | P1 |
...
| # | Task | 상태 | 설명 |
|---|------|------|------|
| 3-1-1 | WatchlistItem 모델 | ⏳ 대기 | DB 모델 + Alembic 마이그레이션 |
| 3-1-2 | Watchlist Repository | ⏳ 대기 | CRUD 레포지토리 |
| 3-1-3 | Watchlist Service | ⏳ 대기 | 비즈니스 로직 |
| 3-1-4 | Watchlist API 라우터 | ⏳ 대기 | 6개 엔드포인트 |
| 3-1-5 | 종목 검색 API | ⏳ 대기 | KIS API 연동 |
| 3-1-6 | Frontend API 클라이언트 | ⏳ 대기 | lib/api/watchlist.ts |
| 3-1-7 | Watchlist 페이지 | ⏳ 대기 | app/watchlist/page.tsx |
| 3-1-8 | 컴포넌트 구현 | ⏳ 대기 | 모달, 테이블, 검색 |
| 3-1-9 | Trading Engine 연동 | ⏳ 대기 | 매매 대상 종목 조회 |
| 3-1-10 | E2E 테스트 | ⏳ 대기 | 브라우저 테스트 |
