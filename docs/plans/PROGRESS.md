...
| # | Task | 상태 | 우선순위 | 비고 |
|---|------|------|----------|------|
| 1 | 대시보드 차트 구현 (Lightweight Charts) | ⏳ 대기 | P1 | 수익률 현황 |
| 2 | 보유 종목 현황 UI | ⏳ 대기 | P1 | 실시간 가격 |
| 3 | 매매 내역 + AI 판단 근거 표시 | ⏳ 대기 | P2 | - |
| 4 | 사용자 인증 (로그인/회원가입) | ⏳ 대기 | P1 | JWT |
| 5 | 개인별 API 키 관리 | ⏳ 대기 | P1 | AES-256 암호화 |
| 6 | Settings 페이지 API 연동 | ⏳ 대기 | P2 | Trading Mode 변경 |
